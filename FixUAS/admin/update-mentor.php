<?php $title = "Update Mentor"; ?>
<?php include('../layout/header.php') ?>
<?php if (isset($_GET['id'])) : ?>
    <?php
        $id = $_GET['id'];
        $sql = "select email, phone_number, role, password, fullname from users where id = '$id' and role = 'mentor'";
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="fullname" id="" class="form-control" value="<?php echo $data['fullname'] ?>">
                </div>
                <div class="mb-3">
...
if(isset($_POST['submit'])){
    ...
    $sql = "update users set password = '$password', email = '$email', phone_number = '$phoneNumber', fullname = '$fullname', role = '$role' where id = '$id' and role = 'mentor'";
    $res = mysqli_query($conn, $sql);
    if($res) {
