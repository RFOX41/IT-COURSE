                    ...
                    <select name="user_id" id="" class="form-control">
                        ...
                        <?php if ($dataMentor != null) : ?>
                            <?php foreach ($dataMentor as $row) : ?>
                                <option value="<?php echo $row['id']; ?>" <?php echo $row['id'] == $data['user_id'] ? 'selected' : '' ?>><?php echo $row['fullname']; ?></option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                </div>
...
if (isset($_POST['submit'])) {
    ...
    $updateSql = "update content set name = '$name', course_id = '$course', user_id = '$mentor', link_youtube = '$link' where id = '$id'";
