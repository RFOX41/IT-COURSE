        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="<?php echo SITEURL; ?>mentor/add-course.php" class="btn btn-sm btn-primary">Tambah Course</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <tbody>
                    ...
                    $sql = "select ce.id, ce.name as course_name, us.fullname as mentor_name, us.id as mentor_id
                        ...
                        where uc.type = 1 and uc.user_id = '$idUserLogin'
                    ";
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="<?php echo SITEURL; ?>mentor/update-course.php?id=<?php echo $row['id']; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                        ...
                                        <a href="<?php echo SITEURL; ?>mentor/delete-course.php?id=<?php echo $row['id']; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                            <span class="svg-icon svg-icon-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
